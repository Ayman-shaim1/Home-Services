    ...
    <>
      <Screen widthPadding safeArea style={{ paddingTop: 10 }}>
        ...
        <View>
          ...
          <Label
            color={"gray"}
            text={
              "Lorem ipsum Lorem ipsumipsum dolor sit amet, consectetur adipiscing elit. Pellentesque bibendum elit sodales dolor consectetur, eget maximus enim placerat. Sed dictum nisl dui, efficitur euismod dui dictum ut. "
            }
          />
        </View>
        <Diviser />
      ...
      >
        <ScrollView>
          ...
          <DatePicker
            icon={"calendar"}
            placeholder={"veuillez saisire une date"}
            label={"date"}
          />
          <DatePicker
            mode="time"
            icon={"calendar-clock"}
            placeholder={"veuillez saisire une heure de depart"}
            label={"heure de depart"}
          />
          <TextInput
            icon={"cash"}
            keyboardType={"numeric"}
            placeholder={"veuillez saisire le prix par heure"}
            label={"prix mar heure"}
          />
          <TextInput
            icon={"clipboard-clock"}
            keyboardType={"numeric"}
            placeholder={"veuillez saisire le nombre d'heures de travaille"}
            label={"nombre d'heures de travaille"}
          />
