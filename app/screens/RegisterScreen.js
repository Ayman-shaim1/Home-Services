...
export default function RegisterScreen({ navigation }) {
  return (
    <Screen widthPadding safeArea>
      ...
      <TextInput label="nom" placeholder="entrer votre nom " icon="account" />

      <TextInput label="email" placeholder="entrer un email" icon="email" />
      ...
      <View style={styles.signinTextContainer}>
        <Text style={styles.signinText}>aleady have an account</Text>
