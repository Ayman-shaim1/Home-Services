  ...
  return (
    <Screen widthPadding safeArea>
      ...
      <TextInput
        multiline
        label="description"
        placeholder="entrer votre une description "
        icon="account"
        value={
          "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec porta maximus magna, eu pellentesque purus mollis vel. Quisque interdum lorem id ipsum varius, nec pulvinar ipsum congue. "
        }
      />
